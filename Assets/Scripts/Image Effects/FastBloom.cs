...
public class FastBloom : PostEffectsBase {
    ...
    public void OnRenderImage(RenderTexture source, RenderTexture destination) {
        ...
        for (int i = 0; i < blurIterations; i++) {
            ...
            Graphics.Blit(rt, rt2, fastBloomMaterial, (int)(BlurType)Enum.ToObject(typeof(BlurType), 2 + passOffs));
            ...
            rt2.filterMode = FilterMode.Bilinear;
            Graphics.Blit(rt, rt2, fastBloomMaterial, (int)(BlurType)Enum.ToObject(typeof(BlurType), 3 + passOffs));
            RenderTexture.ReleaseTemporary(rt);
            rt = rt2;
        }
